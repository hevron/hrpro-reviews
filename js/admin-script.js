var HRPro_Reviews_Admin = (function($) {
    "use strict";
    ...
    return {
        ...
        prepare_overall_rating_label: function(){
            ...
            HRPro_Reviews_Admin.calculate_overall_rating();
        ...
        add_span: function(){
            ...
            $(".bf-section-repeater-option[data-id=_bs_review_criteria] .bf-heading-repeater-option h3").append( '<span class="overall-label">' + hrpro_reviews_loc.overall_rating + ' ( <i>-</i> )</span>' );
        ...
        calculate_overall_rating: function(){
            ...
            var $num = HRPro_Reviews_Admin.add_span();
            ...
            $num.html( HRPro_Reviews_Admin.format_overall_rating_number( total, $parent.find('.bs-review-field-rating input').length ) );
